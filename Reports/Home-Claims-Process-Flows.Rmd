...
# Fetch data
query_branches <- "SELECT * FROM T_CLAIMS_HOME_DISTINCT_PAID"
...
Home claims are defined by excluding life related dangers (accident, pet) and special riders like assistance.
